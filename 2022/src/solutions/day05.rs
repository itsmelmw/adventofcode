...
fn solve1(stacks: &mut Vec<Vec<char>>, moves: &Vec<(usize, usize, usize)>) -> String {
    for mov in moves {
        for _ in 0..mov.0 {
...
fn solve2(stacks: &mut Vec<Vec<char>>, moves: &Vec<(usize, usize, usize)>) -> String {
    for mov in moves {
...
pub fn solve(input: &str) -> (String, String) {
    ...
    return (solve1(&mut stacks1, &moves), solve2(&mut stacks2, &moves));
}
